...
class RedBlackBSTTest 
{
	...
	/**
	 * Prueba 13:Verifica que el iterator en las llaves del escenario 1 y 2 si esten funcionado correctamente
	 */
	@Test
	void testKeys() 
	{
		setupEscenario1();
		Iterator<Integer> llaveArbol1 = arbolRojoNegro1.keys().iterator();
		int cont = 0;
		while(llaveArbol1.hasNext())
		{
			cont++;
		}
		assertEquals(5, cont);
		...
		setupEscenario2();
		Iterator<Integer> llaveArbol1 = arbolRojoNegro2.keys().iterator();
		int cont = 0;
		while(llaveArbol1.hasNext())
		{
			cont++;
	...
	/**
	 * Prueba 14:Verifica que el iterator en los valores del escenario 1 y 2 si esten funcionado correctamente
	 */
	@Test
	void testValues() 
	{
		...
		setupEscenario2();
		Iterator<String> llaveArbol1 = arbolRojoNegro2.keys().iterator();
		int cont = 0;
		while(llaveArbol1.hasNext())
		{
			cont++;
